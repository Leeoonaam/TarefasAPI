...
namespace TarefasAPI.Controllers 
{
    ...
    public class TarefaController : Controller 
    {
        ...
        public IActionResult Sincronizar([FromBody] List<Tarefa> tarefas) 
        {
            // Chama o método Sicronizacao do repositório e retorna o resultado com um status 200 OK.
            return Ok(_tarefarepository.Sicronizacao(tarefas)); 
        }

        [HttpGet("restaurar")] // Define a rota para o método de restauração.
        // Define a ação de restauração, que aceita uma data como parâmetro.
        public IActionResult Restaurar(DateTime data) 
        {
